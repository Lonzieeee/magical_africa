    ...
    <>
      ...
      <section className="music-section">
        ...
        <div className="music-artists-grid">
          <div className="music-artist-card">
            <div className="music-artist-avatar" style={{ background: '#FFF3E0' }}>🎤</div>
          ...
          <div className="music-artist-card">
            <div className="music-artist-avatar" style={{ background: '#FCE4EC' }}>🎙️</div>
            <div className="music-artist-info">
              <h4>Miriam Makeba</h4>
          ...
          <div className="music-artist-card">
            <div className="music-artist-avatar" style={{ background: '#E8F5E9' }}>🔥</div>
            <div className="music-artist-info">
              <h4>Burna Boy</h4>
          ...
          <div className="music-artist-card">
            <div className="music-artist-avatar" style={{ background: '#EDE7F6' }}>✨</div>
            <div className="music-artist-info">
              <h4>Tems</h4>
          ...
          <div className="music-artist-card">
            <div className="music-artist-avatar" style={{ background: '#E3F2FD' }}>🎸</div>
            <div className="music-artist-info">
          ...
          <div className="music-artist-card">
            <div className="music-artist-avatar" style={{ background: '#FFF8E1' }}>🎹</div>
            <div className="music-artist-info">
