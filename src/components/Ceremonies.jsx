  ...
  return (
    ...
    <div className='Ceremonies-div'>
      ...
      <div className='ceremony1'>
        ...
        <div className='ceremony1-b'>

        <div className='ceremony-img2'>
        ...
        <div className='ceremony-text'>
          ...
          <p>
           The Ga people of Ghana "hoot at hunger" with this vibrant harvest celebration. Families reunite, ancestral rites are performed, and the streets overflow with kpokpoi, the traditional dish.
          </p>
        ...
        <div className='ceremony1-c'>

          <div className='ceremony-img3'>
